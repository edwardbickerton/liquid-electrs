<template>
  <div class="flex min-h-full h-screen flex-col items-center justify-center p-2">
    ...
    <div class="loading-footer flex flex-col items-center p-4 text-center">
      <svg
        class="loading-footer-logo mb-1 mt-2"
        width="158"
        height="78"
        viewBox="0 0 158 78"
        fill="none"
      ...
      <span class="font-semibold" style="color: #7776f5;">Umbrel</span>
    </div>
  </div>
</template>
