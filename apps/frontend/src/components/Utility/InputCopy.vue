<template>
  <div
    class="mt-1 flex w-full items-center justify-between border-2 border-dashed border-gray-200 bg-white px-4 py-2 font-mono dark:border-gray-600 dark:bg-neutral-900 dark:text-white"
  >
    <input
      ref="copy-input-field"
      v-model="valueProxy"
      type="text"
      class="-mr-2 w-full bg-transparent outline-none"
      readonly
    />

    <span class="copy-icon-btn" @click="copyText">
      <svg
        width="18"
        height="18"
        viewBox="0 0 18 18"
